...
const BlurText = ({
  ...
  return (
    <span ref={ref} className={cn(className)} style={{ display: 'inline-flex', flexWrap: 'wrap' }}>
      {elements.map((segment, index) => {
        ...
        const wordClassName = shouldHighlight ? highlightClassName : ''
